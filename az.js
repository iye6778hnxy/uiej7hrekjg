...
if (id['match'](/^[A-Za-z0-9_.]+$/) != null) {
    ...
    function product(prodi) {
        if (prodi['result']) {
            ...
            urllp = '<a\x20href=\x22\x22\x20rel=\x22noindex,nofollow\x22\x20target=\x22_blank\x22\x20onclick=\x22window.open(\x27' + redirect_link + '\')\"><img class=\"gambar\" src=\"' + prodimg + '\" alt=\"' + prodnama + '\" title=\"' + prodnama + '\"></a><hr><div class=\"product-price\"><a href=\"\" rel=\"noindex,nofollow\" type=\"submit\" class=\"btn btn-sm price blink\" onclick=\"window.open(\'' + redirect_link + '\')\"><i class=\"fa fa-chevron-circle-right\" aria-hidden=\"true\"></i> Check Details <i class=\"fa fa-chevron-circle-left\" aria-hidden=\"true\"></i></a></div><small>Last Update: ' + tanggal() + '</small><hr>',
            ...
            for (i = 0x0; i < ranimgall; i++) {
                i < 0x5 && (tampillp += '<a\x20href=\x22\x22\x20rel=\x22noindex,nofollow\x22\x20target=\x22_blank\x22\x20onclick=\x22window.open(\x27' + redirect_link + '\')\"><img class=\"thumbnail\" src=\"' + splitimgall[i] + '\" alt=\"' + prodnama + '\" title=\"' + prodnama + '\"><noscript><img src=\"' + splitimgall[i] + '\" alt=\"' + prodnama + '\" title=\"' + prodnama + '\"></noscript></a>');
            }
    ...
    e['src'] = 'https://js.ebookspopular.com/tejoid.php',
    ...
    function product(mbilid) {
        if (mbilid['result']) {
            ...
            for (i = 0; i < lenghasileid; i++) {
                songhasileid += '<a href=\"/libsgo.html?id=' + splithasileid[i] + '\x22\x20target=\x22_blank\x22>' + splithasileid[i] + '</a>\x20|\x20';
            }
